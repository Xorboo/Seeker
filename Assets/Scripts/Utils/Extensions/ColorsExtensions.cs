...
public static class ColorsExtensions
{
    ...
    public static string ToHexString(this Color color, bool insertHashTag = false)
    {
        Color32 col = color;
        string hex = (insertHashTag ? "#" : "") + col.r.ToString("X2") + col.g.ToString("X2") + col.b.ToString("X2");
        return hex;
    }
